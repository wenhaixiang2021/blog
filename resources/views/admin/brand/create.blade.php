...
@csrf
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="firstname" name="brand_name" placeholder="请输入名字">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="lastname" name="brand_url" placeholder="请输入姓">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea type="text" class="form-control" id="lastname" name="brand_desc" placeholder="请输入姓"></textarea>
    </div>
  </div>
